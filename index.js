...
const buttonemoji = document.getElementById('button-emoji')
...
buttonemoji.addEventListener('click', emojiee)
    ...
    if (document.querySelector('input[type="radio"]:checked')) {
        ...
        const matchingCatsArray = catsData.filter(function(cat) {
            ...
            if (isGif) {
                ...
                return cat.emotionTags.includes(selectedEmotion) && cat.isGif === false
            }
        })
